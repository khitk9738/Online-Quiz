...
<title>CollegeBuddy || TEST YOUR SKILL </title>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>CollegeBuddy</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/team.jpg" width=100 height=100 alt="Akshit Sharma" class="img-rounded">
		 </div>
		 <div class="col-md-5">
